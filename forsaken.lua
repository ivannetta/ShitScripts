...
local function FartHubLoad()
  ...
  local function CheckAndDeleteAssets()
    local basePath = "FartHub/Assets/"
    local sigmaFilePath = "FartHulocal TweenService = game:GetService("TweenService")
    local UserInputService = game:GetService("UserInputService")
    local Workspace = game:GetService("Workspace")
    local KeySystem
    local Frame
    ...
    FartHubLoad()local TweenService = game:GetService("TweenService")
    local UserInputService = game:GetService("UserInputService")
    local Workspace = game:GetService("Workspace")
    local KeySystem
    local Frame
